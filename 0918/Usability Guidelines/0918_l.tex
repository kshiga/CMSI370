...
\pagebreak
\section*{Reflections}
\textit{These reflections reflect those of Lisa Rosenbaum.  The same report, but with Lisa For this experiment we had people change the desktop background, change the
